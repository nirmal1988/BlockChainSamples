...
module.exports.process_msg = function(ws, data, owner){
	...
	if(data.type == "chainstats"){
		...
		if(data.part){
			if(data.part.warrantyStartDate) {
				...
				chaincode.invoke.updatePart([data.part.partId, data.part.vehicleId, data.part.dateOfDelivery, data.part.dateOfInstallation, owner], cb_invoked_updatepart);	//update part details
			}
		}		
	}
